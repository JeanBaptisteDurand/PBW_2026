// Pure counterparty classifier — ported from v1 corlens/apps/server/src/analysis/counterpartyClassifier.ts
// No I/O. No logger. No xrpl/openai/prisma imports.

import type { XRPLAsset } from "./types.js";

// ─── Types (from v1 historyTypes.ts) ────────────────────────────────────────
