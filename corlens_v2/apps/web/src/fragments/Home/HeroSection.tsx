...
export function HeroSection({ onAnalyzeRLUSD, onSafePath, onCorridorHealth }: HeroSectionProps) {
  return (
    <div className="mb-16 flex flex-col items-center gap-6 text-center">
      ...
      <h1 className="max-w-3xl text-5xl font-bold leading-tight tracking-tight text-white">
        The missing map for <span className="text-xrp-400">XRPL cross-border payments</span>
      </h1>

      <p className="max-w-2xl text-lg leading-relaxed text-slate-400">
        2,436 fiat corridors classified by how they settle on XRPL. An AI agent that routes capital
        through them safely — with live risk analysis, split routing, and downloadable compliance
        reports.
      </p>
