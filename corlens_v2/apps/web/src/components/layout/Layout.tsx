...
import { GlobalStarfield } from "./GlobalStarfield.js";
...
export function Layout(): JSX.Element {
  ...
  const isLandingRoute = displayedPathname === "/landing" || displayedPathname === "/";
  ...
  return (
    <div className={layoutClassName} data-page-theme={pageTheme}>
      ...
      {!isLandingRoute && <div className="global-background-glass" aria-hidden="true" />}
      {!isLandingRoute && <Navbar />}
      <main className={isLandingRoute ? "relative z-10" : "relative z-10 pt-14"}>
        <div
          className={[
            "route-transition",
...
function getPageTheme(pathname: string): "home" | "analyze" | "corridors" | "safe-path" {
  if (
  ...
  if (pathname.startsWith("/safe-path")) return "safe-path";
  return "home";
}
