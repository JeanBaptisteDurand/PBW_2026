...
import { HomeBackground } from "../fragments/Home/HomeBackground.js";
import { RLUSD_ISSUER } from "../lib/constants.js";
    ...
    <div className="app-content-min-height relative overflow-hidden">
      ...
      <section className="mx-auto max-w-5xl px-6 pt-20 pb-16">
        <div className="flex flex-col items-center gap-6 text-center">
          ...
          <h1 className="max-w-3xl text-5xl font-bold leading-tight tracking-tight text-white">
            The missing map for{" "}
            <span className="text-[color:var(--page-accent-400)]">XRPL cross-border payments</span>
          </h1>

          <p className="max-w-2xl text-lg leading-relaxed text-slate-400">
            2,436 fiat corridors classified by how they settle on XRPL. An AI agent that routes
            capital through them safely — with live risk analysis, split routing, and downloadable
            compliance reports.
          </p>
          ...
          <div className="mt-2 flex flex-wrap items-center justify-center gap-4">
            ...
            <Button variant="secondary" size="lg" onClick={() => navigate("/safe-path")}>
              Route with Safe Path Agent
            </Button>
            <Button
              variant="secondary"
              size="lg"
              onClick={() => navigate(`/analyze?address=${RLUSD_ISSUER}&label=RLUSD`)}
            >
              Audit an Entity
            </Button>
          </div>
      ...
      <section className="mx-auto max-w-6xl px-6 pb-20">
        <div className="text-center mb-10">
          ...
          <p className="text-sm text-slate-400 max-w-2xl mx-auto">
            Make the infrastructure that moves money on XRPL legible, auditable, and trustworthy —
            for institutions, fintechs, and the 700M people at the bottom of the remittance
            pipeline.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          >
            ...
            <CardHeader>
              <div className="flex items-center justify-between">
                <span className="text-2xl text-[color:var(--page-accent-400)]">◈</span>
            ...
            <CardContent>
              <p className="text-sm leading-relaxed text-slate-400 mb-3">
                ...
                moves money: native IOU orderbooks, hybrid legacy, or off-chain RLUSD bridge via
                named partners.
              </p>
          ...
          >
            ...
            <CardContent>
              <p className="text-sm leading-relaxed text-slate-400 mb-3">
                A real tool-using agent, not a chatbot. Calls six tools against the live XRPL,
                rejects risky paths, proposes split routing, and generates a downloadable compliance
                report.
              </p>
              <div className="flex flex-wrap gap-1.5">
          ...
          >
            ...
            <CardContent>
              <p className="text-sm leading-relaxed text-slate-400 mb-3">
                The same crawler the agent calls internally — exposed standalone. 18 node types, 19
                edge types, crawled live on XRPL mainnet. The proof the agent's tools are not
                mocked.
              </p>
              <div className="flex flex-wrap gap-1.5">
        ...
        <div className="mx-auto max-w-6xl px-6 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="rounded-xl border border-[color:var(--app-glass-panel-border)] bg-[var(--app-glass-panel-bg)] p-5 shadow-[var(--app-glass-panel-shadow)] backdrop-blur-md">
            <div className="flex items-center gap-2 mb-3">
              ...
              <span className="text-sm">🇲🇽</span>
              <span className="ml-2 text-xs font-bold text-white">USD → MXN</span>
            ...
            <div className="bg-slate-950/60 border border-slate-800 rounded p-3 mb-3">
              ...
              <p className="text-[11px] text-slate-300 leading-relaxed">
                Real-world fiat lane from US Dollar to Mexican Peso. The route bridges via RLUSD
                held by 15 source-side and 3 destination-side partners. 2 Ripple ODL partners
                service this corridor. 16 of 18 actors publish confirmed RLUSD support.
              </p>
            </div>
            <div className="flex gap-2 mb-3">
              <div className="flex-1 bg-slate-950/60 border border-slate-800 rounded p-2 text-center">
                <div className="text-[9px] text-slate-500 uppercase">On-ramps</div>
                <div className="text-sm font-bold text-white">15</div>
              </div>
              <div className="flex-1 bg-slate-950/60 border border-slate-800 rounded p-2 text-center">
                <div className="text-[9px] text-slate-500 uppercase">Off-ramps</div>
                <div className="text-sm font-bold text-white">3</div>
              </div>
              <div className="flex-1 bg-slate-950/60 border border-slate-800 rounded p-2 text-center">
                <div className="text-[9px] text-slate-500 uppercase">ODL partners</div>
      ...
      <section className="mx-auto max-w-6xl px-6 pb-20">
        <div className="text-center mb-12">
          ...
          <p className="text-sm text-slate-400 max-w-2xl mx-auto">
            The Safe Path Agent queries the Corridor RAG, launches Entity Audit analyses, queries
            their RAG chats, crawls XRPL accounts, researches actors online, and generates
            compliance reports — all streamed live.
          </p>
        </div>
        ...
        <div className="relative mx-auto" style={{ maxWidth: 720, height: 600 }}>
          ...
          >
            {[
              ...
              <line
                // biome-ignore lint/suspicious/noArrayIndexKey: static decorative line set, never reorders.
                key={i}
                x1={x1}
                y1={y1}
                x2={x2}
          ...
          {[
            {
              ...
              icon: "RAG",
              title: "Corridor RAG",
              desc: "Queries corridor intelligence for route strategy",
            },
            {
              x: "83%",
              y: 120,
              ...
              icon: "BFS",
              title: "Deep Analyze",
              desc: "Launches Entity Audit (depth-2 BFS) on critical accounts",
            },
            {
              x: "89%",
              y: 350,
              ...
              icon: "AI",
              title: "Analysis RAG",
              desc: "Queries each analysis RAG for risk summaries",
            },
            {
              x: "72%",
              y: 530,
              ...
              icon: "WEB",
              title: "Web Research",
              desc: "Investigates actor reputation and licensing",
            },
            {
              x: "28%",
              y: 530,
              color: "red",
              icon: "ACC",
              title: "Crawl Accounts",
              desc: "Flags clawback, freeze, permissions on each hop",
            },
            {
              x: "11%",
              y: 350,
              ...
              icon: "LIQ",
              title: "Partner Depth",
              desc: "Live orderbook depth from Bitso and DEX",
            },
            {
              x: "17%",
              y: 120,
              ...
              desc: "Generates full compliance report with evidence",
            },
          ].map((tool, i) => (
            <div
              // biome-ignore lint/suspicious/noArrayIndexKey: static tool list, never reorders.
              key={i}
              className="absolute -translate-x-1/2 -translate-y-1/2"
              style={{ left: tool.x, top: tool.y }}
            >
              <div
                className={`w-[130px] rounded-lg border border-${tool.color}-500/30 bg-slate-950/80 backdrop-blur p-3 text-center`}
              >
                <div
                  className={`inline-flex items-center justify-center w-8 h-8 rounded-full bg-${tool.color}-500/15 border border-${tool.color}-500/40 text-[10px] font-bold text-${tool.color}-300 mb-1.5`}
                >
                  {tool.icon}
                </div>
                ...
                <div className="text-[9px] text-slate-500 leading-snug mt-0.5">{tool.desc}</div>
              </div>
            </div>
          ))}
        </div>
        ...
        <div className="mt-4 text-center">
          <p className="text-xs text-slate-500 max-w-xl mx-auto mb-5">
            The agent queries the <strong className="text-violet-400">Corridor RAG</strong> for
            route intel, then launches{" "}
            <strong className="text-emerald-400">Entity Audit analyses</strong> and queries{" "}
            <strong className="text-sky-400">their RAG chats</strong> for risk summaries. It's a
            real orchestrator consuming the entire CorLens ecosystem.
          </p>
          <Button
            size="lg"
            onClick={() => navigate("/safe-path")}
      ...
      <section className="relative py-20">
        ...
        <div className="mx-auto max-w-6xl px-6 grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div>
            ...
            <h2 className="text-2xl font-bold text-white mb-3">17+ automated risk detectors</h2>
            <p className="text-sm text-slate-400 mb-5">
              The Entity Audit crawler scans every account on every hop and flags issues
              automatically. The Safe Path Agent rejects paths with HIGH-severity flags — here's
              what it catches:
            </p>
          ...
          <div>
            ...
            <p className="text-sm text-slate-400 mb-5">
              Every product surface has an AI chat grounded in real data — not hallucinated, not
              generic. RAG-powered, scoped to context.
            </p>
            ...
            <div className="rounded-xl border border-violet-500/20 bg-[var(--app-glass-panel-bg)] p-5 mb-4 backdrop-blur-md">
              <div className="flex items-center gap-2 mb-3">
                ...
                <div>
                  <div className="text-xs font-semibold text-white">Corridor RAG Chat</div>
              ...
              <div className="space-y-2">
                ...
                <ChatBubble speaker="ai">
                  5 GCC corridors have confirmed RLUSD support on both legs: SAR↔USD, AED↔USD,
                  QAR↔USD, BHD↔USD, KWD↔USD. All via Rain Financial (Bahrain) as the regional RLUSD
                  gateway...
                </ChatBubble>
              </div>
            </div>
            ...
            <div className="rounded-xl border border-emerald-500/20 bg-[var(--app-glass-panel-bg)] p-5 backdrop-blur-md">
              <div className="flex items-center gap-2 mb-3">
                ...
                <div>
                  <div className="text-xs font-semibold text-white">Entity Audit Chat</div>
                  <div className="text-[10px] text-slate-500">On every knowledge graph</div>
                </div>
              </div>
              <div className="space-y-2">
                <ChatBubble speaker="user">
                ...
                <ChatBubble speaker="ai">
                  RLUSD is a regulated stablecoin issued by Ripple. Clawback (XLS-39) is enabled for
                  regulatory compliance — it lets the issuer recall tokens in case of fraud or
                  sanctions enforcement. This is expected for institutional stablecoins...
                </ChatBubble>
              </div>
            </div>
          </div>
      ...
      <section className="mx-auto max-w-6xl px-6 pb-20">
        <div className="text-center mb-10">
          ...
          <h2 className="text-3xl font-bold text-white mb-3">Built for institutional trust</h2>
        </div>
      ...
      <section className="relative py-20">
        ...
        <div className="mx-auto max-w-4xl px-6 text-center">
          ...
          <h2 className="text-3xl font-bold text-white mb-6">The gap CorLens fills</h2>
              ...
              <tbody className="divide-y divide-slate-800">
                {[
                  [
                    "XRPL explorers",
                    "XRPScan, Bithomp",
                    "Raw on-chain data only. No corridor concept.",
                  ],
                  ["Ripple tools", "Liquidity Hub", "Partner-only, closed. Not public."],
                  [
                    "Stablecoin dashboards",
                    "Artemis, DefiLlama",
                    "RLUSD supply only. Zero routing data.",
                  ],
                  [
                    "Blockchain forensics",
                    "Chainalysis, Elliptic",
                    "KYT/sanctions focus. Not corridor health.",
                  ],
                  [
                    "Cross-chain agg.",
                    "LI.FI, Jumper",
                    "XRPL not integrated. Fiat is onramp-only.",
                  ],
                  [
                    "Closest adjacent",
                    "Utility Scan",
                    "Historical ODL volume only. No classification, no agent.",
                  ],
                ].map(([cat, who, why]) => (
      ...
      <section className="mx-auto max-w-5xl px-6 pb-20 text-center">
        ...
        <p className="text-sm text-slate-400 mb-6 max-w-xl mx-auto">
          Browse the corridor atlas, let the AI agent route your capital, or audit any entity on
          XRPL — all live on mainnet, right now.
        </p>
        <div className="flex flex-wrap items-center justify-center gap-4 mb-8">
          ...
          <Button variant="secondary" size="lg" onClick={() => navigate("/developers")}>
            Read the API Docs
          </Button>
        </div>
        ...
        <div className="flex items-center justify-center gap-6 opacity-60">
          ...
          >
            ...
            >
              ...
              />
              <path
                d="M22.5 18.5l-3 5.196a1 1 0 01-.866.5h-6a1 1 0 01-.866-.5l-3-5.196a1 1 0 010-1l3-5.196a1 1 0 01.866-.5h6a1 1 0 01.866.5l3 5.196a1 1 0 010 1z"
                fill="white"
              />
            </svg>
          ...
          <div className="flex items-center gap-2">
            ...
            >
              ...
              <path
                d="M23.07 11.49l-1.43-.83-1.42-.82-1.43-.83-1.42-.82L16 7.37l-1.37.82-1.43.82-1.42.83-1.43.82-1.42.83v1.64l1.42.82V15.6l-1.42.82v1.65l1.42.82 1.43.83 1.42.82 1.43.83L16 22.19l1.37-.82 1.43-.83 1.42-.82 1.43-.83 1.42-.82v-1.65l-1.42-.82v-1.65l1.42-.82zm-8.5 7.45l-1.42-.82-1.43-.83v-1.64l1.43.82 1.42.82 1.43.83v1.64zm5.68-3.28l-1.43.83-1.42.82-1.43.82v-1.64l1.43-.82 1.42-.83 1.43-.82z"
                fill="white"
              />
            </svg>
...
function RiskFlagRow({
  ...
  return (
    <div
      className={`rounded-lg border ${colors.split(" ").slice(2).join(" ")} bg-slate-950/40 p-3`}
    >
      <div className="flex items-center gap-2 mb-1">
        <span className={`px-1.5 py-0 rounded text-[9px] font-bold border ${colors}`}>
          {severity}
        </span>
        <span className="text-[11px] font-mono font-semibold text-white">{flag}</span>
      </div>
    ...
    >
      <span
        className={`text-[9px] font-bold uppercase tracking-widest ${
          speaker === "user" ? "text-slate-500" : "text-violet-400"
        } block mb-0.5`}
      >
        {speaker === "user" ? "You" : "AI"}
      </span>
