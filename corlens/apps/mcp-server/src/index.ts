...
// ─── CorLens MCP Server ────────────────────────────────────────────────
//
// Exposes the CorLens REST API as MCP tools for Claude.
...
//
// Env vars:
//   CORLENS_API_URL  — Base URL of the CorLens API (default: https://cor-lens.xyz/api)
//   CORLENS_API_KEY  — JWT token from your CorLens account (required for premium features)
...
const API_BASE = process.env.CORLENS_API_URL ?? "https://cor-lens.xyz/api";
