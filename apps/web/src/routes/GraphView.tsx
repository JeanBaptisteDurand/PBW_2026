...
import type { GraphNode, GraphEdge, NodeKind, EdgeKind } from "@xrplens/core";
import { EDGE_COLORS, NODE_COLORS } from "@xrplens/core";

const LEGEND_FILTER_STORAGE_KEY = "xrplens.graphview.filters.v1";
