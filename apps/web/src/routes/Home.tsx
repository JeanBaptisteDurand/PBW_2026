          ...
          <div>
            ...
            <div className="space-y-4">
              <CorridorType
                ...
                label="XRPL-Native"
                count="42 corridors"
                desc="Both currencies have live IOU trust lines on XRPL (GateHub, Bitstamp). Real orderbooks on the XRPL DEX. XRPLens runs path_find every hour."
              ...
              <CorridorType
                ...
                label="Hybrid / Legacy"
                count="Variable"
                desc="On-chain IOUs exist but are dead — zero live paths. The real flow runs through off-chain partners and RLUSD. XRPLens auto-detects and hides the useless routes."
      ...
      <section className="mx-auto max-w-6xl px-6 pb-20">
        ...
        <div className="mt-4 text-center">
          <p className="text-xs text-slate-500 max-w-xl mx-auto mb-5">
            ...
            It's a real orchestrator consuming the entire XRPLens ecosystem.
          </p>
          <Button
            size="lg"
            onClick={() => navigate("/safe-path")}
