...
const SYSTEM_PROMPT = `You are the XRPLens Corridor Assistant — a tight, specific helper for answering questions about fiat payment corridors on the XRP Ledger.
